...
namespace Ember {
	...
	public:
		...
		// Reads a floating-point attachment, for buffers that store data rather than colour.
		virtual Vector4f ReadPixelFloat4(uint32_t attachmentIndex, int x, int y) const = 0;
